...
import { BarChart3, Cpu, RefreshCw, Layers, CheckCircle2, ShieldCheck, AlertTriangle } from 'lucide-react';
...
export default function EvaluationPage() {
  ...
  const fetchMetrics = async () => {
    ...
    try {
      ...
      setError('Model metrics unavailable. Train the model first.');
      setMetrics(null);
    } finally {
      setLoading(false);
    }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
            <div className="bg-card border border-subtle p-4 rounded-xl space-y-1.5 shadow-sm">
              ...
              <div className="text-3xl font-black text-emerald-500">
                {metrics?.roc_auc != null ? (metrics.roc_auc * 100).toFixed(2) + '%' : '—'}
              </div>
            ...
            <div className="bg-card border border-subtle p-4 rounded-xl space-y-1.5 shadow-sm">
              ...
              <div className="text-3xl font-black text-blue-500">
                {metrics?.precision != null ? (metrics.precision * 100).toFixed(2) + '%' : '—'}
              </div>
            ...
            <div className="bg-card border border-subtle p-4 rounded-xl space-y-1.5 shadow-sm">
              ...
              <div className="text-3xl font-black text-amber-500">
                {metrics?.recall != null ? (metrics.recall * 100).toFixed(2) + '%' : '—'}
              </div>
            ...
            <div className="bg-card border border-subtle p-4 rounded-xl space-y-1.5 shadow-sm">
              ...
              <div className="text-3xl font-black text-purple-500">
                {metrics?.f1_score != null ? (metrics.f1_score ?? 0).toFixed(4) : '—'}
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 font-mono">
            ...
            <div className="lg:col-span-8 bg-card border border-subtle p-5 rounded-xl space-y-4 shadow-sm">
              ...
              <div className="space-y-2 text-xs">
                {metrics?.shap_ranking && metrics.shap_ranking.length > 0 ? (
